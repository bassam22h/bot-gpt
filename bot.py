...
async def generate_post_content(user_input: str, platform: str) -> str:
    try:
        ...
        1. الإخراج باللغة العربية الفصحى فقط
        2. احتفظ بجميع الهاشتاقات (#) والوصلات (_) الأصلية
        3. استخدم 3-5 إيموجي فقط
        4. الطول: {PLATFORM_LIMITS[platform]} حرفاً كحد أقصى
        5. الهيكل: 2-3 جمل قصيرة + 3-5 هاشتاقات
        6. لا تكتب أي شروحات أو تفاصيل تقنية
        
        مثال:
        شراكة لتمكين الشباب وتوفير فرص العمل 🚀
        ...
        completion = client.chat.completions.create(
            ...
            model="meta-llama/llama-3-70b-instruct",  # الاسم الصحيح للنموذج
            messages=[
